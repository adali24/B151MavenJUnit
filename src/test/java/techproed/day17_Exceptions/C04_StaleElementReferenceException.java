...
public class C04_StaleElementReferenceException extends TestBase {
    ...
    */
    ...
    public void test04() {
        ...
        List<WebElement>  ilkBesUrun= driver.findElements(By.xpath("//*[@class='a-size-medium a-color-base a-text-normal']"));
        for (int i = 0; i < ilkBesUrun.size(); i++) {
            ilkBesUrun.get(i).click(); // --> org.openqa.selenium.StaleElementReferenceException
            bekle(2);
