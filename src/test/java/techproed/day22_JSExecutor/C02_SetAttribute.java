...
public class C02_SetAttribute extends TestBase {
    ...
    public void test01() {
        ...
        js.executeScript("arguments[o].value='QA'",aramaKutusu);//-->value attribute deger olarak QA yazdir
 ...
 */
    ...
    public void test04() {
        ...
        WebElement aramaKutusu = driver.findElement(By.xpath("//*[@type='search']"));
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].setAttribute('id','Hamit')",aramaKutusu);
        //-->elementor-search-form-9f26725 normal de id atribute değeri
        driver.findElement(By.id("Hamit")).sendKeys("Java", Keys.ENTER);
